...
export default function Footer() {
    ...
    return (
        <footer className="relative mt-24 border-t border-zinc-800/70 bg-zinc-950/60">
            {/* finom glow a jobb oldalon */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute right-0 h-80 w-80 rounded-full bg-orange-500/10 blur-3xl -top-24" />
            </div>
            ...
            <div className="relative mx-auto max-w-350 px-6 py-16">
                <div className="grid md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-5">
                        <Link href="/" className="flex items-center gap-3">
                            ...
                            <div className="leading-none">
                                <div className="text-lg font-semibold tracking-[0.18em] text-zinc-100">
                                    EMBERLINE
                                </div>
                                <div className="text-xs font-medium tracking-[0.22em] text-orange-500">
                                    TATTOO
                                </div>
                            </div>
                        </Link>
                    ...
                    <div className="md:col-span-3">
                        <h3 className="text-xs font-semibold tracking-[0.26em] text-zinc-200">
                            GYORS LINKEK
                        </h3>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            {navItems.map((l) => (
                                <li key={l.href}>
                                    <Link
                                        href={l.href}
                                        className="hover:text-orange-400 transition text-zinc-400"
                                    >
                                        {l.label}
                                    </Link>
                                </li>
